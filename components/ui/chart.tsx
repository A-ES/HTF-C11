...
// Create a tooltip component for charts
export function ChartTooltip({
  children,
  className,
  ...props
}: ChartTooltipProps<ValueType, NameType> & {
  className?: string
}) {
  return <>{props.content || <ChartTooltipContent />}</>
}

// Create a tooltip content component for charts
